    ...
    <div className="min-h-screen bg-sand text-charcoal flex flex-col">
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto w-full">
        <div className="text-center mb-16">
          <h2 className="font-heading text-4xl text-teal mb-4">{t('home.featured_title')}</h2>
          <p className="font-body text-terracotta-dark italic">{t('home.featured_subtitle')}</p>
        </div>

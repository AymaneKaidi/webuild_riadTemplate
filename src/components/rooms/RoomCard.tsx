...
export default function RoomCard({ room }: { room: Room }) {
  ...
  return (
    <div className="group flex flex-col bg-white overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
      {/* Image Placeholder */}
      ...
      <div className="p-4 md:p-6 flex flex-col flex-grow">
        ...
        <div className="flex items-center justify-between mt-auto pt-4 border-t border-sand">
          ...
          <button className="px-4 py-2 bg-terracotta text-white font-body text-xs uppercase tracking-widest hover:bg-terracotta-dark transition-colors">
            View Room
          </button>
        </div>
      </div>
